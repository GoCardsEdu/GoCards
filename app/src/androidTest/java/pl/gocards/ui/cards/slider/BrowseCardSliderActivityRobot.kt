...
class BrowseCardSliderActivityRobot(
    composeTestRule: ComposeTestRule,
    var activityScenario: ActivityScenario<BrowseCardSliderActivity>,
    var activity: BrowseCardSliderActivity,
    ...
    companion object {
        ...
        fun startActivity(
            composeTestRule: ComposeTestRule,
            deckDbPath: String
        ): BrowseCardSliderActivityRobot {
            val application: Application = ApplicationProvider.getApplicationContext()
            val intent = Intent(application, BrowseCardSliderActivity::class.java).apply {
                putExtra(StudyCardSliderActivity.DECK_DB_PATH, deckDbPath)
                addFlags(Intent.FLAG_ACTIVITY_NEW_TASK)
            }

            val activityScenario = ActivityScenario.launch<BrowseCardSliderActivity>(intent)
            var activity: BrowseCardSliderActivity? = null
            activityScenario.onActivity { activity = it }
            return BrowseCardSliderActivityRobot(composeTestRule, activityScenario, activity!!, deckDbPath)
        }
    }
