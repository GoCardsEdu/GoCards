 ...
 */
public abstract class IconInToolbarFragment extends BaseFragment {
    ...
    public CharSequence menuIconWithText(@NonNull Drawable r, String title) {
        ...
        r.setColorFilter(
                MaterialColors.getColor(requireView(), R.attr.colorIcon),
    ...
    protected Drawable getDrawableHelper(int id) {
        return AppCompatResources.getDrawable(requireActivity(), id);
    }
}
