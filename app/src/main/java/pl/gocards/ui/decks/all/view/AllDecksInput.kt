...
class AllDecksInputFactory(
    ...
    fun create(): AllDecksInput {
        ...
        val import = ImportDeckAction(adapter, fileSyncViewModel, onRefreshItems, activity, owner)
        val deckActions = DeckActions(adapter, onRefreshItems, application)
        val importExportDb = ImportDbAction(adapter, onRefreshItems, activity, scope)
        ...
        return AllDecksInput(
            ...
            menu = ListAllDecksMenuData(
                ...
                onClickImportExcel = import.onClickImport(),
                onClickImportCsv = import.onClickImport(),
                onClickImportDb = importExportDb.onClickImportDb(),
            ...
            page = ListAllDecksPageData(
                ...
                emptyFolder = EmptyFolderData(
                    ...
                    onClickImport = import.onClickImport()
                ),
