...
public class SelectCardBaseViewAdapter
    ...
    public void onClickDeleteSelected() {
        ...
        List<Integer> deletedPositions = selectedCards
                .stream()
        ...
        Completable.fromAction(
                ...
                .doOnComplete(() -> {
                    ...
                    getActivity().runOnUiThread(
                            () -> {
                                deletedPositions.stream().forEach(position -> notifyItemRemoved(position));
                                int startPosition = deletedPositions.get(0);
                                int countItem = getItemCount() - startPosition + 1;
                                loadItems(startPosition, countItem);
                                selectedCards.clear();
    ...
    private void revertCards(@NonNull List<Card> cards) {
        getDeckDb().cardDao().restoreAsync(cards)
                ...
                .doOnComplete(() -> {
                    ...
                    getActivity().runOnUiThread(() -> loadItems(), this::onErrorRevertCards);
    ...
    protected void onErrorRevertCards(Throwable e) {
        getExceptionHandler().handleException(
                ...
                "Error while restoring the deleted cards."
        );
    }
