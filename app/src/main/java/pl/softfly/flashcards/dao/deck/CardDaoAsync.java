...
public abstract class CardDaoAsync {
    ...
    public abstract Maybe<List<Card>> getAllCards();
    ...
    public abstract Maybe<List<Card>> searchCards(String search);
    ...
    public abstract Maybe<List<Integer>> findIdsByDisabledTrueCards();
