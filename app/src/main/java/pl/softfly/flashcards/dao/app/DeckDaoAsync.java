...
public abstract class DeckDaoAsync {
    ...
    public abstract Maybe<List<Deck>> findByFolder(String folderPath);
        ...
        return findByKey(path)
                ...
                .doOnEvent((value, error) -> {
                    if (value == null && error == null) {
                        Deck deck = new Deck();
                        deck.setName(getDeckName(finalPath));
                        deck.setPath(finalPath);
                        deck.setLastUpdatedAt(TimeUtil.getNowEpochSec());
                        insert(deck);
                    }
                });
    ...
    public abstract Completable updatePathByPath(String oldPath, String newPath);
