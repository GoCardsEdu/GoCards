Feature: Sync the Excel file with the Deck. Find similar cards. Stress tests.
  ...
  Scenario Outline: ST_02 Similar <repeat> cards.
    ...
    Given Generate cards <repeat> times into the file:
      | Sample Term excel {i} | Sample Definition excel {i} | Other {i} |
    When Synchronize the Excel file with the deck.
    Then <repeat> cards in the deck.
    Then <repeat> cards in the imported file.
    Then The expected deck with cards:
      | Sample Term excel 1 | Sample Definition excel 1 | Other 1 |
      | Sample Term excel 2 | Sample Definition excel 2 | Other 2 |
      | Sample Term excel 3 | Sample Definition excel 3 | Other 3 |
    Then Check the deck with cards.
    Then Check the Excel file.
    Examples:
      | repeat |
  ...
  Scenario Outline: ST_03 Merging new cards.
    ...
    Given Generate cards <repeat> times into the file:
      ...
      | Excel Excel 1 {i} | Excel Excel 1 {i} | Other {i} |
      | Excel Excel 2 {i} | Excel Excel 2 {i} | Other {i} |
      | Excel Excel 3 {i} | Excel Excel 3 {i} | Other {i} |
    When Synchronize the Excel file with the deck.
    ...
    Then The expected deck with cards:
      ...
      | Excel Excel 1 1 | Excel Excel 1 1 | Other 2 |
      | Excel Excel 2 1 | Excel Excel 2 1 | Other 3 |
      | Excel Excel 3 1 | Excel Excel 3 1 | Other 4 |
    Then Check the deck with cards.
    Then Check the Excel file.
    Examples:
      | repeat | expected |
