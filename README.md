...
- C_02 Display all cards.
    ...
    - C_D_04 Delete the card by clicking in the popup menu.
        - C_U_05 Undo card removal
    - C_D_06 Delete the card by swiping.
        - C_U_07 Undo card(s) removal
    ...
    - After selecting the card(s)
        - C_D_11 Delete selected card(s)
            - C_D_12 Undelete the selected card(s) 
...
- Review database
- **The first version in the store**
- Chose an application name
- Icon design
- Enabling and disabling modules
- Add html editor
- Add adding images
- Move the main pages to Android Composer
  - Sliding the main pages